...
::
::   Homepages: https://github.com/Afnanaltaf0/IDMScript
::              https://github.com/Afnanaltaf0/IDMScript
::              https://Afnanjamber7.blogspot.com
::              https://YouTube.com/@AfnanJamberEdits
::              https://YouTube.com/@AHMobile
::              https://AH-Mobile.blogspot.com
::
::       Email: afnanjamber@keemail.me
::
::============================================================================
...
cls
color 07
title  IDMScript By AfnanJamber %iasver%
...
%eline%
echo You are running outdated version Activator 
echo ________________________________________________
echo:
...
choice /C:10 /N
if !errorlevel!==2 rem
if !errorlevel!==1 (start https://github.com/Afnanaltaf0/IDMScript & exit /b)
)
)
...
cls
title  AFNANJAMBER's IDM %iasver%
...
echo:
echo Check this page for https://github.com/Afnanaltaf0/IDMScript
goto done2
)
...
if %_erl%==5 start https://github.com/Afnanaltaf0/IDMScript & start https://Afnanjamber7.blogspot.com & start https://YouTube.com/@AfnanJamberEdits & start https://YouTube.com/@AHMobile & start https://AH-Mobile.blogspot.com exit /b
if %_erl%==4 start https://github.com/Afnanaltaf0/IDMScript & start https://Afnanjamber7.blogspot.com & start https://YouTube.com/@AfnanJamberEdits & start https://YouTube.com/@AHMobile & start https://AH-Mobile.blogspot.com & goto MainMenu
if %_erl%==3 start https://www.internetdownloadmanager.com/download.html & start https://github.com/Afnanaltaf0/IDMScript & start https://Afnanjamber7.blogspot.com & start https://YouTube.com/@AfnanJamberEdits & start https://YouTube.com/@AHMobile & start https://AH-Mobile.blogspot.com  & goto MainMenu
...
call :register_IDM
 start https://github.com/Afnanaltaf0/IDMScript & start https://Afnanjamber7.blogspot.com & start https://www.youtube.com/@ahkms & start https://YouTube.com/@AfnanJamberOfficial & start https://YouTube.com/@AHMobile & start https://AH-Mobile.blogspot.com
...
echo %line%
echo:
call :_color %RED% "SUBSCRIBE To Give an Other Way to Help You."
echo:
...
echo:
echo Help: https://github.com/Afnanaltaf0/IDMScript
...
If not defined name set name=Gift By AfnanJamber
...
set "reg=HKCU\SOFTWARE\DownloadManager /v Email /t REG_SZ /d "AfnanJamber@keemail.me"" & call :_rcont
...
set "reg=HKU\%_sid%\SOFTWARE\DownloadManager /v Email /t REG_SZ /d "Ajinin1110@gmail.com"" & call :_rcont
